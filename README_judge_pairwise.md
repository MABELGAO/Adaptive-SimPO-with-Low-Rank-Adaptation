...
This document explains how to use [src/judge_pairwise.py](/Users/vainreve/My%20Drive/NUS/Sem%202/DSA5106/Group%20Project/Adaptive-SimPO-with-Low-Rank-Adaptation/src/judge_pairwise.py) for pairwise evaluation of model responses.
...
- [alpaca_eval_dpo_responses.minimal.jsonl](/Users/vainreve/My%20Drive/NUS/Sem%202/DSA5106/Group%20Project/Adaptive-SimPO-with-Low-Rank-Adaptation/alpaca_eval_dpo_responses.minimal.jsonl)
...
```bash
python3 -m src.judge_pairwise pair \
  --file-a alpaca_eval_dpo_responses.minimal.jsonl \
...
```bash
python3 -m src.judge_pairwise trio \
  --file-a path/to/dpo.jsonl \
...
- Judge script: [src/judge_pairwise.py](/Users/vainreve/My%20Drive/NUS/Sem%202/DSA5106/Group%20Project/Adaptive-SimPO-with-Low-Rank-Adaptation/src/judge_pairwise.py)
- Cleaning script: [src/clean_alpaca_eval_responses.py](/Users/vainreve/My%20Drive/NUS/Sem%202/DSA5106/Group%20Project/Adaptive-SimPO-with-Low-Rank-Adaptation/src/clean_alpaca_eval_responses.py)
- DPO minimal response file: [alpaca_eval_dpo_responses.minimal.jsonl](/Users/vainreve/My%20Drive/NUS/Sem%202/DSA5106/Group%20Project/Adaptive-SimPO-with-Low-Rank-Adaptation/alpaca_eval_dpo_responses.minimal.jsonl)
